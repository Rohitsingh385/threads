...
import { threadSchema, threadIdSchema, usernameSchema, updateThreadSchema } from "./thread.validation.js"
...
router.get('/user/:username', validate(usernameSchema), getThreadByUsernameController)
